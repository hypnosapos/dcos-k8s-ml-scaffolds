...
curl -L -H "Authorization: token ${GITHUB_TOKEN}" -o helm.tar.gz https://storage.googleapis.com/kubernetes-helm/helm-${TAG_NAME}-linux-amd64.tar.gz
...
helm install seldon-core --name seldon-core-analytics \
     --repo https://storage.googleapis.com/seldon-charts \
